from tkinter import Frame, Button, LEFT, Image
...
class EditBar(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.image = ImageTk.PhotoImage(file="logos.png")
        Button(self, image=self.image, command=lambda: print('click'), width=50, height=50).pack()
